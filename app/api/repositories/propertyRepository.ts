...
export class PropertyRepository {
   ...
   */
  static getAllActiveProperties = async (): Promise<Property[]> => {
   ...
   * @returns Promise resolving to an array of Property records
   */
  static getAllActivePropertiesByHomeownerIdIn = async (homeownerIds: number[]): Promise<Property[]> => {
    const properties = await db<Property[]>`
      SELECT *
      FROM properties
   ...
   */
  static getPropertyById = async (propertyId: number): Promise<Property | null> => {
